...
function photographerTemplate(data) {
    const { name, city, country, tagline, price, portrait } = data; // extraire les données nécessaires du photographe
    ...
    return { getUserCardDOM } // Retourne l'objet contenant la fonction pour obtenir le DOM de la carte
}
